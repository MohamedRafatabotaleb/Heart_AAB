...
#else
// Use the updated TMPro editor utility class name to resolve the missing reference.
using TMP_UiEditorPanel = TMPro.EditorUtilities.TMP_EditorPanelUI;
#endif
...
namespace RTLTMPro
{
    ...
    // Inherit from the updated TMPro editor class to fix the compilation error.
